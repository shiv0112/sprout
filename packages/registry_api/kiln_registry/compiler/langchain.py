"""
kiln_registry/compiler/langchain.py
───────────────────────────────────
Compiles a KilnTool into a LangChain StructuredTool.

LangChain expects:
    - StructuredTool with name, description, func, args_schema
    - args_schema is a Pydantic BaseModel class

We dynamically build the Pydantic model from the KilnToolSpec params,
so you get full type validation and schema generation for free.

Usage:
    compiled = runtime.get("com.kiln.tools.weather", target="langchain")
