...
class SemanticIndex:
    ...
    @staticmethod
    def _doc_text(tool: KilnTool) -> str:
    ...
    def rebuild(self, tools: Iterable[KilnTool]) -> None:
...
def refresh_semantic_index(tools: Iterable[KilnTool]) -> None:
