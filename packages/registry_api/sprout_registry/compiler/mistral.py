"""
sprout_registry/compiler/mistral.py
──────────────────────────────────
Compiles a SproutTool into Mistral-compatible tool definitions.
...
Usage:
    compiled = runtime.get("com.sprout.tools.weather", target="mistral")
...
class MistralAdapter(BaseAdapter):
    ...
    def compile(self, tool: SproutTool) -> CompiledMistralTool:
        """
        Build the Mistral tool definition dict from the SproutToolSpec
