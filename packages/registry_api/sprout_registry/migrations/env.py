"""Alembic environment for sprout_registry.

Resolves the database URL from the same place the app does
(``sprout_registry.db._get_database_url``) so migrations and runtime never
...
from sprout_registry.db import Base, _get_database_url
