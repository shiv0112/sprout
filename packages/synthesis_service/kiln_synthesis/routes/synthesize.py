"""
kiln_synthesis.routes.synthesize
--------------------------------
...
from kiln_synthesis.models import JobStatus, SynthesizeRequest, SynthesizeResponse
from kiln_synthesis.pipeline import run_synthesis_pipeline

router = APIRouter()


@router.post("/synthesize", response_model=SynthesizeResponse, summary="Synthesize a new Kiln tool")
