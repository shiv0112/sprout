"""
sprout_synthesis.routes.health
----------------------------
...
def livez() -> dict:
    ...
    return {"status": "ok", "service": "sprout-synthesis-service"}
...
async def readyz() -> dict | JSONResponse:
    ...
    Pings the registry's /livez at the URL derived from SPROUT_SYNTHESIS_CALLBACK_URL.
    ...
    body: dict = {
        "status": overall,
        "service": "sprout-synthesis-service",
        "checks": checks,
    }
    if overall != "ok":
