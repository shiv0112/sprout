"""
sprout_executor/main.py
─────────────────────
Sprout Tool Executor — isolated, sandboxed tool execution service.
...
from sprout_shared.auth import verify_internal_secret
...
class ExecuteRequest(BaseModel):
    ...
    tool_id: str = Field(..., description="Sprout tool ID, e.g. com.sprout.tools.weather")
...
def health():
    return {"status": "ok", "service": "sprout-tool-executor"}
