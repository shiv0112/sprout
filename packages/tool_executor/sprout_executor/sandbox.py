"""
sprout_executor/sandbox.py
────────────────────────
Isolated subprocess execution for Sprout tools.
...
async def run_in_sandbox(
    ...
    with tempfile.TemporaryDirectory(prefix=f"sprout_exec_{tool_id.split('.')[-1]}_") as tmpdir:
